...
<link rel="stylesheet" href="<?php echo base_url('assets/css/custom-style.css?v=' . (is_file(FCPATH . 'assets/css/custom-style.css') ? filemtime(FCPATH . 'assets/css/custom-style.css') : version_combine()));?>">
