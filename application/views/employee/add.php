...
<?php } ?>
					...
					<div class="row" id="branch_dept_wrapper">
					...
					<!-- next of kin details -->
					<div class="headers-line mt-md">
						<i class="fas fa-users"></i> Next of Kin Details
					</div>
					<div class="row">
						<div class="col-md-4 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="far fa-user"></i></span>
									<input class="form-control" name="next_of_kin_name" type="text" value="<?=set_value('next_of_kin_name')?>" autocomplete="off" />
								</div>
							</div>
						</div>
						<div class="col-md-4 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input class="form-control" name="next_of_kin_phone" type="text" value="<?=set_value('next_of_kin_phone')?>" autocomplete="off" />
								</div>
							</div>
						</div>
						<div class="col-md-4 mb-sm">
							<div class="form-group">
								...
								<input class="form-control" name="next_of_kin_relation" type="text" value="<?=set_value('next_of_kin_relation')?>" autocomplete="off" />
							</div>
						</div>
					</div>
