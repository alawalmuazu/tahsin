								...
								<div class="row">
									<div class="col-md-4 mb-sm">
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="far fa-user"></i></span>
												<input class="form-control" name="next_of_kin_name" type="text" value="<?=set_value('next_of_kin_name', $staff['next_of_kin_name'])?>" />
											</div>
										</div>
									</div>
									<div class="col-md-4 mb-sm">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control" name="next_of_kin_phone" type="text" value="<?=set_value('next_of_kin_phone', $staff['next_of_kin_phone'])?>" />
											</div>
										</div>
									</div>
									<div class="col-md-4 mb-sm">
										<div class="form-group">
											...
											<input class="form-control" name="next_of_kin_relation" type="text" value="<?=set_value('next_of_kin_relation', $staff['next_of_kin_relation'])?>" />
										</div>
									</div>
								</div>
