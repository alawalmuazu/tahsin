...
<?php } ?>
					...
					<div class="row">
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								...
								<?php
									...
									echo form_dropdown("relation", $arrayRelation, set_value('relation', $parent['relation']), "class='form-control' data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
								?>
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								<label class="control-label">Age <span class="required">*</span> <small class="text-muted">(Must be 18+)</small></label>
								<input type="number" min="18" class="form-control" name="age" value="<?=set_value('age', isset($parent['age']) ? $parent['age'] : '')?>" autocomplete="off" />
