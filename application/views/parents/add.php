				...
				<div class="row">
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<?php
								...
								echo form_dropdown("relation", $arrayRelation, set_value('relation'), "class='form-control' data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
							?>
						</div>
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<input type="number" min="18" class="form-control" name="age" value="<?=set_value('age')?>" autocomplete="off" placeholder="Age in years" />
						</div>
