				...
				<table class="table table-bordered table-hover mb-none table-export">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php if (!empty($row['curriculum_pdf'])) { ?>
									<a href="<?=base_url('uploads/curriculum/' . $row['curriculum_pdf'])?>" class="btn btn-default btn-circle icon" target="_blank" data-toggle="tooltip" title="<?=translate('download')?>">
