		...
		<div class="tab-content">
			<div id="edit" class="tab-pane active">
				...
				<input type="hidden" name="subject_id" value="<?=$subject['id']?>">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?=translate('curriculum_pdf')?></label>
						<div class="col-md-6">
							<input type="file" class="form-control" name="curriculum_pdf" accept="application/pdf" />
							<?php if (!empty($subject['curriculum_pdf'])): ?>
								<span class="help-block"><i class="fas fa-file-pdf"></i> Current File: <a href="<?=base_url('uploads/curriculum/' . $subject['curriculum_pdf'])?>" target="_blank"><?=$subject['curriculum_pdf']?></a></span>
							<?php endif; ?>
							<span class="error"></span>
						</div>
					</div>
