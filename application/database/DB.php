<?php
/**
 * Application DB bootstrap — loads MY_DB_* drivers from application/core.
 * Used instead of system/database/DB.php (system/ is gitignored).
 */
...
function &DB($params = '', $query_builder_override = NULL)
{
	...
	// Prefer application MY_DB_* driver when present (audit trail).
