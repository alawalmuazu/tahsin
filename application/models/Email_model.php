...
class Email_model extends CI_Model
{
    ...
    public function sendAccountSetupInvite($data)
    {
        $setup_url = base_url('authentication/setup_account/' . $data['setup_token']);
        
        $message = "Hello " . $data['name'] . ",<br><br>";
        $message .= "Your account has been created at " . get_global_setting('institute_name') . ". Please click the link below to securely set your username and password, and activate your account:<br><br>";
        $message .= "<a href='" . $setup_url . "'>Setup My Account</a><br><br>";
        $message .= "If the link doesn't work, copy and paste this URL into your browser:<br>" . $setup_url . "<br><br>";
        $message .= "Thank you.";

        $msgData['recipient'] = $data['email'];
        $msgData['subject'] = "Account Setup Invitation";
        $msgData['message'] = $message;
        $msgData['branch_id'] = isset($data['branch_id']) ? $data['branch_id'] : '';
